...
import org.eventb.emf.core.diagram.edit.policies.ContextItemSemanticEditPolicy;
...
public class ContextEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(EventbcoreElementTypes.ContextExtends_4007);
		return types;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.eventb.emf.core.diagram.edit.parts.ContextEditPart) {
			types.add(EventbcoreElementTypes.ContextExtends_4007);
		}
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == EventbcoreElementTypes.ContextExtends_4007) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		} else if (relationshipType == EventbcoreElementTypes.ContextExtends_4007) {
			types.add(EventbcoreElementTypes.Context_2001);
		}
		return types;
	}
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 225, 188, 228);
