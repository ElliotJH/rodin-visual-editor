...
import org.eventb.emf.core.diagram.edit.policies.EventbcoreTextSelectionEditPolicy;
...
public class WrappingLabel4EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				EventbcoreVisualIDRegistry
						.getType(org.eventb.emf.core.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected Image getLabelIcon() {
		...
		return EventbcoreElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EventbcoreParserProvider.getParser(
