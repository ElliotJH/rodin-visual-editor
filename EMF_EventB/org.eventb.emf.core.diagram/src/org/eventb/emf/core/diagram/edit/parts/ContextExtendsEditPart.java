...
import org.eventb.emf.core.diagram.edit.policies.ContextExtendsItemSemanticEditPolicy;
...
public class ContextExtendsEditPart extends ConnectionNodeEditPart implements
	...
	public class ContextExtendsFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureExtends;
		...
		private void createContents() {
			...
			fFigureExtends = new WrappingLabel();

			fFigureExtends.setText("Extends");

			this.add(fFigureExtends);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureExtends() {
			return fFigureExtends;
		}
