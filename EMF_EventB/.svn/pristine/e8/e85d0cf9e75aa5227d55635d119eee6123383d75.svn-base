 ...
 * @since 1.1
 */
public class EventBMatchScopeProvider implements IMatchScopeProvider {
	 ...
	 */
	public EventBMatchScopeProvider(EObject leftObject, EObject rightObject) {
		this.leftScope = new EventBMatchScope(leftObject);
		this.rightScope = new EventBMatchScope(rightObject);
	}
	 ...
	 */
	public EventBMatchScopeProvider(EObject leftObject, EObject rightObject, EObject ancestorObject) {
		this(leftObject, rightObject);
		this.ancestorScope = new EventBMatchScope(ancestorObject);
	}
	 ...
	 */
	public EventBMatchScopeProvider(Resource leftResource, Resource rightResource) {
		this.leftScope = new EventBMatchScope(leftResource);
		this.rightScope = new EventBMatchScope(rightResource);
	}
	 ...
	 */
	public EventBMatchScopeProvider(Resource leftResource, Resource rightResource, Resource ancestorResource) {
		this(leftResource, rightResource);
		this.ancestorScope = new EventBMatchScope(ancestorResource);
	}
	 ...
	 */
	public EventBMatchScopeProvider(ResourceSet leftResourceSet, ResourceSet rightResourceSet) {
		this.leftScope = new EventBMatchScope(leftResourceSet);
		this.rightScope = new EventBMatchScope(rightResourceSet);
	}
	...
	public EventBMatchScopeProvider(ResourceSet leftResourceSet, ResourceSet rightResourceSet,
		...
		this.ancestorScope = new EventBMatchScope(ancestorResourceSet);
	}
	...
	public void applyResourceFilter(IResourceFilter filter) {
		if (ancestorScope != null) {
			applyExternalFilter(filter, ((EventBMatchScope)leftScope).getResourcesInScope(),
					((EventBMatchScope)rightScope).getResourcesInScope(), ((EventBMatchScope)ancestorScope)
							.getResourcesInScope());
		} else {
			applyExternalFilter(filter, ((EventBMatchScope)leftScope).getResourcesInScope(),
					((EventBMatchScope)rightScope).getResourcesInScope());
		}
	}
